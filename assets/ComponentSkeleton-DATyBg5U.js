import{h as U,g as T,ak as k,s as y,e as h,ag as B,al as f,r as x,p as A,b as F,j as t,v as L,w as P,B as R,S as l,T as c,G as r,M as W,P as X}from"./index-CzaIiVEe.js";function E(a){return String(a).match(/[\d.\-+]*\s*(.*)/)[1]||""}function N(a){return parseFloat(a)}function G(a){return U("MuiSkeleton",a)}T("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const K=["animation","className","component","height","style","variant","width"];let p=a=>a,v,w,b,C;const D=a=>{const{classes:i,variant:n,animation:s,hasChildren:o,width:u,height:d}=a;return P({root:["root",n,s,o&&"withChildren",o&&!u&&"fitContent",o&&!d&&"heightAuto"]},G,i)},O=k(v||(v=p`
  0% {
    opacity: 1;
  }
